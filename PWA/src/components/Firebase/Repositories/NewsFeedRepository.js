  ...
  saveDbNewsFeed = async (newsFeed, saveDbNewsFeed_completed) => {
    ...
    if (!nfid) {
      ...
      newsFeed = {
        ...
        isIndigiShareMedia: isIndigiShareMedia || false,
      ...
      if (dbNewsFeed) {
        newsFeed = {
          ...
          isIndigiShareMedia: typeof isIndigiShareMedia === 'boolean' ? isIndigiShareMedia : dbNewsFeed.isIndigiShareMedia || false,
          nfid: nfid,
          updated: updated || now.toString(),
