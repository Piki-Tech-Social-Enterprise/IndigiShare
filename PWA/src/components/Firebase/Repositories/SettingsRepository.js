    ...
    if (!sid) {
      ...
      if (dbSettings) {
        settings = {
          ...
          aboutPageIndigiShareBackOfficeStructureDescription: aboutPageIndigiShareBackOfficeStructureDescription || dbSettings.aboutPageIndigiShareBackOfficeStructureDescription,
          aboutPageIndigiShareBackOfficeStructureImageUrl: aboutPageIndigiShareBackOfficeStructureImageUrl || dbSettings.aboutPageIndigiShareBackOfficeStructureImageUrl,
