...
const INITIAL_STATE = {
  ...
  aboutPageIndigiShareBackOfficeStructureDescription: '',
  sid: null,
  aboutPageIndigiShareBackOfficeStructureImageUrl: '',
  aboutPageIndigiShareBackOfficeStructureImageUrlFile: null,
...
const AuthSettingsView = props => {
  ...
  const handleSubmit = async e => {
    ...
    const {
      ...
      aboutPageDescription,
      aboutPageIndigiShareBackOfficeStructureDescription,
      aboutPageIndigiShareBackOfficeStructureImageUrlFile,
      aboutPageExtraDescription,
      newsSectionDescription,
      gmailEmail,
      gmailPassword
    ...
    let aboutPageIndigiShareBackOfficeStructureImageUrl = settings.aboutPageIndigiShareBackOfficeStructureImageUrl;
    let displayIcon = 'error';
    let displayTitle = 'Updating Settings Failed';
    let displayMessage = '';
    try {
      if (!homePageHeaderImageUrl || !homePageAboutImageUrl || !homePageAboutDescription || !aboutPageDescription || !aboutPageIndigiShareBackOfficeStructureDescription) {
        displayMessage = 'The Home Page Header Image, Home Page About Image, Home Page About Description, About Page Description, and About Page IndigiShare Back Office Structure Description fields are required.';
      ...
      } else if (aboutPageIndigiShareBackOfficeStructureImageUrlFile && aboutPageIndigiShareBackOfficeStructureImageUrlFile.size > maxImageFileSize) {
        const {
          size
        } = aboutPageIndigiShareBackOfficeStructureImageUrlFile;
        throw new Error(`Images greater than ${formatBytes(maxImageFileSize)} (${formatInteger(maxImageFileSize)} bytes) cannot be uploaded.<br /><br />Actual image size: ${formatBytes(size)} (${formatInteger(size)} bytes)`);
        ...
        if (aboutPageIndigiShareBackOfficeStructureImageUrlFile && aboutPageIndigiShareBackOfficeStructureImageUrlFile.name) {
          aboutPageIndigiShareBackOfficeStructureImageUrl = getImageUrl(settingHomePageHeaderImageUrlFormat, settingKeyFormat, sid, settingFilenameFormat, aboutPageIndigiShareBackOfficeStructureImageUrlFile.name, '');
          await firebase.saveStorageFile(aboutPageIndigiShareBackOfficeStructureImageUrl, aboutPageIndigiShareBackOfficeStructureImageUrlFile);
        }
        await firebase.saveDbSettings({
          ...
          aboutPageIndigiShareBackOfficeStructureDescription: aboutPageIndigiShareBackOfficeStructureDescription,
          aboutPageIndigiShareBackOfficeStructureImageUrl: aboutPageIndigiShareBackOfficeStructureImageUrl,
  ...
  const handleAboutPageIndigiShareBackOfficeStructureImageUrlChange = async e => {
    e.preventDefault();
    if (e.target && e.target.files && e.target.files.length) {
      const aboutPageIndigiShareBackOfficeStructureImageUrlFile = e.target.files[0];
      setSettings(s => ({
        ...s,
        aboutPageIndigiShareBackOfficeStructureImageUrlFile: aboutPageIndigiShareBackOfficeStructureImageUrlFile
      }));
    }
  };
                    ...
                    : <Form noValidate onSubmit={handleSubmit}>
                      ...
                      >
                        ...
                        <TabPane tabId={2}>
                          ...
                          <FormGroup>
                            <Label>About Page IndigiShare Back Office Structure Description</Label>
                            <DraftEditor
                              content={settings.aboutPageIndigiShareBackOfficeStructureDescription}
                              onChange={handleChange}
                              uploadCallback={handleUploadCallback}
                              contentFieldName="aboutPageIndigiShareBackOfficeStructureDescription"
                            />
                          </FormGroup>
                          <FormGroup>
                            <Label>About Page IndigiShare Back Office Structure Image</Label>
                            <FirebaseInput
                              value={settings.aboutPageIndigiShareBackOfficeStructureImageUrl || ''}
                              onChange={handleChange}
                              downloadURLInputProps={{
                                id: 'aboutPageIndigiShareBackOfficeStructureImageUrl',
                                name: 'aboutPageIndigiShareBackOfficeStructureImageUrl',
                                placeholder: 'About Page IndigiShare Back Office Structure Image',
                                type: 'text'
                              }}
                              downloadURLInputGroupAddonIconClassName="now-ui-icons arrows-1_cloud-upload-94"
                              downloadURLFileInputOnChange={handleAboutPageIndigiShareBackOfficeStructureImageUrlChange}
                              downloadURLFormat={settingHomePageHeaderImageUrlFormat}
                              downloadURLFormatKeyName={settingKeyFormat}
                              downloadURLFormatKeyValue={settings.sid || ''}
                              downloadURLFormatFileName={settingFilenameFormat}
