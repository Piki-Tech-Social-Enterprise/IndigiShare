...
import indigiShareZui20210720Image from '../assets/img/IndigiShare-Zui-20210720-1920x1080.webp';
        ...
        <Col xs={12}>
          ...
          <Row>
            ...
            <Col xs={12} sm={6} className="order-lg-2 order-1">
              <img
                alt="IndigiShare Zui 2021-07-20"
                src={indigiShareZui20210720Image}
                className="w-100"
              />
            </Col>
          </Row>
